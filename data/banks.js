...
export const ALL_BANKS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  { id:"enbd", name:"Emirates NBD", color:"#0066B3", type:"Conventional", category:"national", hq:"Dubai", exchange:"DFM", est:1963, profit2025:24.0, profit2024:23.0, totalAssets:1086, yoyGrowth:4, roe:21.0, featured:true, hasProducts:true, nplRatio:2.5, grossLoans:700, nplPrior:3.3, retailLoans:245, corpLoans:455 },
  { id:"fab", name:"First Abu Dhabi Bank", color:"#003B5C", type:"Conventional", category:"national", hq:"Abu Dhabi", exchange:"ADX", est:1968, profit2025:21.1, profit2024:17.0, totalAssets:1200, yoyGrowth:24, roe:17.5, featured:true, hasProducts:true, nplRatio:2.5, grossLoans:616, nplPrior:3.7, retailLoans:155, corpLoans:461 },
  { id:"adcb", name:"ADCB", color:"#D4145A", type:"Conventional", category:"national", hq:"Abu Dhabi", exchange:"ADX", est:1985, profit2025:11.4, profit2024:9.4, totalAssets:774, yoyGrowth:22, roe:18.2, featured:true, hasProducts:true, nplRatio:1.9, grossLoans:406, nplPrior:3.1, retailLoans:130, corpLoans:276 },
  { id:"mashreq", name:"Mashreq", color:"#E8442A", type:"Conventional", category:"national", hq:"Dubai", exchange:"DFM", est:1967, profit2025:7.0, profit2024:8.8, totalAssets:335, yoyGrowth:-20, roe:20.0, featured:true, hasProducts:true, nplRatio:2.0, grossLoans:230, nplPrior:2.5, retailLoans:55, corpLoans:175 },
  { id:"cbd", name:"Commercial Bank of Dubai", color:"#1C4587", type:"Conventional", category:"national", hq:"Dubai", exchange:"DFM", est:1969, profit2025:2.8, profit2024:2.5, totalAssets:120, yoyGrowth:12, roe:22.0, featured:true, hasProducts:true, nplRatio:3.5, grossLoans:80, nplPrior:4.5, retailLoans:28, corpLoans:52 },
  { id:"rak", name:"RAKBANK", color:"#E31837", type:"Conventional", category:"national", hq:"Ras Al Khaimah", exchange:"ADX", est:1976, profit2025:2.6, profit2024:2.1, totalAssets:105, yoyGrowth:26, roe:22.1, featured:true, hasProducts:true, nplRatio:1.9, grossLoans:56, nplPrior:2.2, retailLoans:32, corpLoans:24 },
  { id:"nbf", name:"National Bank of Fujairah", color:"#00695C", type:"Conventional", category:"national", hq:"Fujairah", exchange:"ADX", est:1984, profit2025:1.2, profit2024:0.85, totalAssets:65, yoyGrowth:42, roe:14.0, featured:true, hasProducts:false, nplRatio:3.95, grossLoans:37.5, nplPrior:5.12, retailLoans:5, corpLoans:32.5 },
  { id:"bos", name:"Bank of Sharjah", color:"#2E7D32", type:"Conventional", category:"national", hq:"Sharjah", exchange:"ADX", est:1973, profit2025:0.73, profit2024:0.39, totalAssets:40, yoyGrowth:89, roe:10.0, featured:true, hasProducts:false, nplRatio:4.5, grossLoans:22, nplPrior:5.5, retailLoans:4, corpLoans:18 },
  { id:"cbi", name:"Commercial Bank International", color:"#5C6BC0", type:"Conventional", category:"national", hq:"Dubai", exchange:"ADX", est:1991, profit2025:0.30, profit2024:0.21, totalAssets:22, yoyGrowth:40, roe:12.0, featured:true, hasProducts:false, nplRatio:3.8, grossLoans:15, nplPrior:4.8, retailLoans:3, corpLoans:12 },
  { id:"uab", name:"United Arab Bank", color:"#6D4C41", type:"Conventional", category:"national", hq:"Sharjah", exchange:"ADX", est:1975, profit2025:0.42, profit2024:0.28, totalAssets:26, yoyGrowth:49, roe:15.6, featured:true, hasProducts:false, nplRatio:4.2, grossLoans:16, nplPrior:5.5, retailLoans:4, corpLoans:12 },
  { id:"investbank", name:"InvestBank", color:"#546E7A", type:"Conventional", category:"national", hq:"Sharjah", exchange:"Private", est:1975, profit2025:0.12, profit2024:0.10, totalAssets:12, yoyGrowth:20, roe:0, featured:true, hasProducts:false, nplRatio:5.0, grossLoans:7, nplPrior:6.0, retailLoans:2, corpLoans:5, note:"Est." },
  { id:"nbq", name:"National Bank of Umm Al Qaiwain", color:"#795548", type:"Conventional", category:"national", hq:"Umm Al Quwain", exchange:"ADX", est:1982, profit2025:0.62, profit2024:0.53, totalAssets:23, yoyGrowth:17, roe:10.0, featured:true, hasProducts:false, nplRatio:3.0, grossLoans:14, nplPrior:3.8, retailLoans:4, corpLoans:10 },
  { id:"abit", name:"Arab Bank for Inv. & Foreign Trade", color:"#37474F", type:"Conventional", category:"national", hq:"Abu Dhabi", exchange:"Private", est:1976, profit2025:0.10, profit2024:0.08, totalAssets:8, yoyGrowth:25, roe:0, featured:true, hasProducts:false, nplRatio:3.5, grossLoans:4, nplPrior:4.0, retailLoans:0.5, corpLoans:3.5, note:"Est." },
  { id:"eib", name:"Emirates Investment Bank", color:"#455A64", type:"Conventional", category:"national", hq:"Dubai", exchange:"Private", est:1976, profit2025:0.05, profit2024:0.04, totalAssets:4, yoyGrowth:25, roe:0, featured:true, hasProducts:false, nplRatio:2.0, grossLoans:2, nplPrior:2.5, retailLoans:0, corpLoans:2, note:"Est." },

  // ═══════════════════════════════════════════════════════════════════════════
  // NATIONAL BANKS — ISLAMIC
  // ═══════════════════════════════════════════════════════════════════════════
  { id:"dib", name:"Dubai Islamic Bank", color:"#006838", type:"Islamic", category:"national", hq:"Dubai", exchange:"DFM", est:1975, profit2025:7.8, profit2024:7.2, totalAssets:416, yoyGrowth:8, roe:21.0, featured:true, hasProducts:true, nplRatio:3.4, grossLoans:350, nplPrior:4.0, retailLoans:120, corpLoans:230 },
  { id:"adib", name:"Abu Dhabi Islamic Bank", color:"#7B2D8E", type:"Islamic", category:"national", hq:"Abu Dhabi", exchange:"ADX", est:1997, profit2025:7.1, profit2024:6.1, totalAssets:281, yoyGrowth:16, roe:29.0, featured:true, hasProducts:true, nplRatio:2.8, grossLoans:200, nplPrior:4.0, retailLoans:80, corpLoans:120 },
  { id:"ei", name:"Emirates Islamic", color:"#00838F", type:"Islamic", category:"national", hq:"Dubai", exchange:"ENBD subsidiary", est:1976, profit2025:3.4, profit2024:2.9, totalAssets:100, yoyGrowth:17, roe:22.0, featured:true, hasProducts:false, nplRatio:2.5, grossLoans:65, nplPrior:3.0, retailLoans:25, corpLoans:40 },
  { id:"sib", name:"Sharjah Islamic Bank", color:"#4E342E", type:"Islamic", category:"national", hq:"Sharjah", exchange:"ADX", est:1975, profit2025:1.32, profit2024:1.05, totalAssets:90, yoyGrowth:26, roe:17.0, featured:true, hasProducts:false, nplRatio:3.0, grossLoans:44, nplPrior:3.8, retailLoans:14, corpLoans:30 },
  { id:"ajman", name:"Ajman Bank", color:"#C75B12", type:"Islamic", category:"national", hq:"Ajman", exchange:"DFM", est:2008, profit2025:0.50, profit2024:0.40, totalAssets:32.9, yoyGrowth:25, roe:15.6, featured:true, hasProducts:true, nplRatio:8.6, grossLoans:18, nplPrior:9.86, retailLoans:7, corpLoans:11 },
  { id:"alhilal", name:"Al Hilal Bank", color:"#8B6914", type:"Islamic", category:"national", hq:"Abu Dhabi", exchange:"ADCB subsidiary", est:2007, profit2025:-0.12, profit2024:-0.12, totalAssets:13.6, yoyGrowth:0, roe:0, featured:true, hasProducts:true, nplRatio:5.0, grossLoans:8, nplPrior:6.0, retailLoans:5, corpLoans:3, note:"Loss-making" },

  // ═══════════════════════════════════════════════════════════════════════════
  // DIGITAL BANKS
  // ═══════════════════════════════════════════════════════════════════════════
  { id:"wio", name:"Wio Bank", color:"#FF6B00", type:"Digital", category:"digital", hq:"Abu Dhabi", exchange:"Private", est:2022, profit2025:0.62, profit2024:0.40, totalAssets:61, yoyGrowth:57, roe:0, featured:true, hasProducts:false, nplRatio:0.5, grossLoans:15, nplPrior:0.8, retailLoans:3, corpLoans:12 },
  { id:"zand", name:"Zand Bank", color:"#FF4081", type:"Digital", category:"digital", hq:"Dubai", exchange:"Private", est:2022, profit2025:0, profit2024:0, totalAssets:5, yoyGrowth:0, roe:0, featured:true, hasProducts:false, nplRatio:0, grossLoans:1, nplPrior:0, retailLoans:0.2, corpLoans:0.8 },
