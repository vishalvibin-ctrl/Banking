...
export const ALL_BANKS = [
  ...
  { id:"alhilal", name:"Al Hilal Bank", color:"#8B6914", type:"Islamic", category:"national", hq:"Abu Dhabi", exchange:"ADCB subsidiary", est:2007, profit2025:-0.12, profit2024:-0.12, totalAssets:13.6, yoyGrowth:0, roe:0, featured:true, hasProducts:true, nplRatio:5.0, grossLoans:8, nplPrior:6.0, retailLoans:5, corpLoans:3, coverageRatio:70, note:"Loss-making" },

  // ═══════════════════════════════════════════════════════════════════════════
  // DIGITAL BANKS
  // ═══════════════════════════════════════════════════════════════════════════
  { id:"wio", name:"Wio Bank", color:"#FF6B00", type:"Digital", category:"digital", hq:"Abu Dhabi", exchange:"Private", est:2022, profit2025:0.62, profit2024:0.40, totalAssets:61, yoyGrowth:57, roe:0, featured:true, hasProducts:false, nplRatio:0.5, grossLoans:15, nplPrior:0.8, retailLoans:3, corpLoans:12, coverageRatio:150 },
  { id:"zand", name:"Zand Bank", color:"#FF4081", type:"Digital", category:"digital", hq:"Dubai", exchange:"Private", est:2022, profit2025:0, profit2024:0, totalAssets:5, yoyGrowth:0, roe:0, featured:true, hasProducts:false, nplRatio:0, grossLoans:1, nplPrior:0, retailLoans:0.2, corpLoans:0.8, coverageRatio:0 },
